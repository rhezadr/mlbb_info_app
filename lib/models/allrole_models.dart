...
//
//     final allHero = allHeroFromJson(jsonString);

import 'dart:convert';

AllRole allRoleFromJson(String str) => AllRole.fromJson(json.decode(str));

String allRoleToJson(AllRole data) => json.encode(data.toJson());
...
class AllRole {
    ...
    factory AllRole.fromJson(Map<String, dynamic> json) => AllRole(
