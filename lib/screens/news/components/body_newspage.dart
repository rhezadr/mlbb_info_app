...
class _BodyState extends State<Body> {
  ...
  List<String> webLink = [
    'https://www.indoesports.com/news/mobile-legends',
    'https://www.oneesports.gg/mobile-legends/',
    'https://esports.id/mobile-legends',
    'https://www.ligagame.tv/esports/mlbb/',
    'https://www.revivaltv.id/category/games/mlbb/',
  ];
